		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ejerciciointegrador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ejerciciointegrador-display": {
								"semanticObject": "ejerciciointegrador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ejerciciointegrador",
									"url": sap.ui.require.toUrl("ejerciciointegrador")
								}
							}
						}
					}
